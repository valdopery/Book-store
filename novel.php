...
<body>
    ...
    <div class="container" style="">
		<div class="top">
			...
			<ul><a href="Cart.php" class="btn" style="font-size:16px;">Educational</a></ul>
		</div>
		<div class="logout"><ul><a href="login.php" class="btn" style="font-size:16px;">My Account</a></ul></div>
        <h2>Novels</h2>
        <?php
            $query = "SELECT * FROM novel ORDER BY id ASC ";
            ...
            if(mysqli_num_rows($result) > 0) {
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    <div class="col-md-3">
                        ...
                        <form method="post" action="novel.php?action=add&id=<?php echo $row["id"]; ?>">
                ...
                if(!empty($_SESSION["cart"])){
                    ...
                    foreach ($_SESSION["cart"] as $key => $value) {
                        ...
                        <tr>
                            ...
                            <td>$ <?php echo $value["product_price"]; $_SESSION['pprice'] = $value["product_price"];?></td>
                            <td>
